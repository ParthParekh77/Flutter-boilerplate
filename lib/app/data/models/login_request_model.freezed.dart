...
class _$_LoginRequestModel implements _LoginRequestModel {
  const _$_LoginRequestModel({required this.name, required this.job});
  ...
  @override
  String toString() {
    return 'LoginRequestModel(name: $name, job: $job)';
  }
...
abstract class _LoginRequestModel implements LoginRequestModel {
  const factory _LoginRequestModel(
      ...
      required final String job}) = _$_LoginRequestModel;
